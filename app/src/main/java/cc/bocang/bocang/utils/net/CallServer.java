...
public class CallServer {
    ...
    public <T> void add(Activity activity, int what, Request<T> request,
                        HttpListener callBack, boolean canCancel, boolean isLoading,boolean isResult) {
        requestQueue.add(what, request, (OnResponseListener<T>) new HttpResponseListener<>(activity, request, callBack,
                canCancel, isLoading,isResult));
    }
