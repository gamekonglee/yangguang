...
//	-----------------end
	...
	public MyPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		//---------------------add
		defaultSize=a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTextViewSize,defaultSize);
		selectSize=a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsSelectTextViewSize,selectSize);
		defaultColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTextViewColor, defaultColor);
		selectColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsSelectTextViewColor, selectColor);
		//---------------------end
